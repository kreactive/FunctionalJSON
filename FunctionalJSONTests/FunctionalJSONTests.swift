...
private func jsonFromAny(any : AnyObject) throws -> JSONValue {
...
private func jsonFromAny(any : Dictionary<String,AnyObject>) throws -> JSONValue {
    return try JSONValue(data: NSJSONSerialization.dataWithJSONObject(any,options: []))
}
private func jsonFromAny(any : Array<AnyObject>) throws -> JSONValue {
    return try JSONValue(data: NSJSONSerialization.dataWithJSONObject(any,options: []))
}
